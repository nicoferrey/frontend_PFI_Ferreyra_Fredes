            ...
            <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-soft flex-1 flex flex-col justify-between">
              ...
              {!isGoogleUser && (
                <div className="pt-6 mt-6 border-t border-slate-100">
                  ...
                  <form id="password-form" onSubmit={handlePasswordSave} className="space-y-5">
                    <div>
                      <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5 mb-1.5">
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-bold px-6 py-3 text-xs md:text-sm shadow-md hover:shadow-lg transition duration-150 disabled:opacity-50"
                      >
                        <ShieldCheck className="h-4 w-4" />
                        <span>{isSubmittingPassword ? 'Guardando...' : 'Cambiar Contraseña'}</span>
                      </button>
                    </div>
                  </form>
                </div>
